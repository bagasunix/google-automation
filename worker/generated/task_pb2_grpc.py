...
from generated import task_pb2 as task__pb2
...
class WorkerServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.ExecuteTask = channel.unary_unary(
                '/searchautomation.WorkerService/ExecuteTask',
...
def add_WorkerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'searchautomation.WorkerService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('searchautomation.WorkerService', rpc_method_handlers)
